...
const SearchForm = () => {
    ...
    return (
        <form
            ...
            className="w-[90%] md:w-[40%] h-19 bg-blend-color-burn pr-4 pl-8 bg-white/90 flex justify-between items-center gap-4 rounded-full text-gray-900 backdrop-blur-sm"
            action=""
        >
            <input
